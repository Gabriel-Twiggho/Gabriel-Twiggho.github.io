...
function replaceExactOptional(nameOrFrom, maybeFrom, maybeTo) {
  const from = maybeTo === undefined ? nameOrFrom : maybeFrom;
  const to = maybeTo === undefined ? maybeFrom : maybeTo;
  if (bundle.includes(to)) return;
...
replaceExact(
  "match card tracker component",
  'function Mv({event:U}){const K=Tv(U.type),fe=U.label||U.text||(U.players.length?U.players.join(" \u00b7 "):U.type),W=X.jsxs("div",{className:"md-ev-cell",children:[X.jsx("i",{className:`md-ev-mark ${K}`}),X.jsxs("div",{className:"md-ev-copy",children:[X.jsx("strong",{children:fe}),X.jsx("span",{children:U.type})]})]});return X.jsxs("div",{className:`md-ev ${U.side}`,children:[X.jsx("div",{className:"md-ev-home",children:U.side==="home"?W:null}),X.jsx("span",{className:"md-ev-min num",children:U.clock||"\u00b7"}),X.jsx("div",{className:"md-ev-away",children:U.side==="away"?W:null})]})}function Q_({roster:U,align:K})',
  'function Mv({event:U}){const K=Tv(U.type),fe=U.label||U.text||(U.players.length?U.players.join(" \u00b7 "):U.type),W=X.jsxs("div",{className:"md-ev-cell",children:[X.jsx("i",{className:`md-ev-mark ${K}`}),X.jsxs("div",{className:"md-ev-copy",children:[X.jsx("strong",{children:fe}),X.jsx("span",{children:U.type})]})]});return X.jsxs("div",{className:`md-ev ${U.side}`,children:[X.jsx("div",{className:"md-ev-home",children:U.side==="home"?W:null}),X.jsx("span",{className:"md-ev-min num",children:U.clock||"\u00b7"}),X.jsx("div",{className:"md-ev-away",children:U.side==="away"?W:null})]})}function Rv({cards:U,match:K}){if(!U.length)return null;const fe=oe=>U.filter(Oe=>Oe.side===oe),W=(oe,Oe)=>{const k=fe(oe),f=k.filter(Ye=>Tv(Ye.type)==="yellow"),se=k.filter(Ye=>Tv(Ye.type)==="red"),ge=Ye=>Ye.label||Ye.text||(Ye.players.length?Ye.players.join(" \u00b7 "):Ye.type),Ne=Ye=>X.jsxs("li",{children:[X.jsx("i",{className:`md-card-chip ${Tv(Ye.type)}`}),X.jsxs("span",{children:[X.jsx("strong",{children:ge(Ye)}),X.jsxs("em",{children:[Ye.clock||"\u00b7"," \u00b7 ",Ye.type]})]})]},`${Ye.clock}-${Ye.type}-${ge(Ye)}`);return X.jsxs("div",{className:`md-card-team ${oe}`,children:[X.jsxs("div",{className:"md-card-teamhead",children:[Oe.logo&&X.jsx("img",{src:Oe.logo,alt:""}),X.jsx("span",{children:Oe.name}),X.jsxs("strong",{children:[f.length,"Y / ",se.length,"R"]})]}),k.length?X.jsx("ul",{children:k.map(Ne)}):X.jsx("p",{className:"md-card-empty",children:"No cards"})]})};return X.jsxs("section",{className:"md-section md-cards-panel",children:[X.jsx("h3",{className:"sub-head",children:"Cards"}),X.jsxs("div",{className:"md-card-grid",children:[W("home",K.home),W("away",K.away)]})]})}function Q_({roster:U,align:K})'
);
...
replaceExact(
  "match card tracker data",
  'const Ke=We=>oe==null?void 0:oe.rosters.find(Mt=>Mt.side===We),Fe=((oe==null?void 0:oe.events)||[]).filter(We=>Sv(We.type)),ot=({side:We,cls:Mt})=>X.jsxs("button"',
  'const Ke=We=>oe==null?void 0:oe.rosters.find(Mt=>Mt.side===We),Fe=((oe==null?void 0:oe.events)||[]).filter(We=>Sv(We.type)),We=Fe.filter(Mt=>{const vt=Tv(Mt.type);return vt==="yellow"||vt==="red"}),ot=({side:Mt,cls:vt})=>X.jsxs("button"'
);

replaceExact(
  "match card tracker team callback names",
  'type:"button",className:`md-team ${Mt}`,onClick:()=>U[We].teamId&&(fe==null?void 0:fe(U[We].teamId)),children:[U[We].logo&&X.jsx("img",{src:U[We].logo,alt:""}),X.jsx("span",{children:U[We].name})]})',
  'type:"button",className:`md-team ${vt}`,onClick:()=>U[Mt].teamId&&(fe==null?void 0:fe(U[Mt].teamId)),children:[U[Mt].logo&&X.jsx("img",{src:U[Mt].logo,alt:""}),X.jsx("span",{children:U[Mt].name})]})'
);
